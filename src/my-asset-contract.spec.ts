...
describe('MyAssetContract', () => {
    ...
    //         await contract.createMyAsset(ctx, '1003', 'x2rj','qukuailian');
    ...
    //         await contract.createMyAsset(ctx, '1001', 'x2rj', 'qukuailian').should.be.rejectedWith(/The my asset 1001 already exists/);
    //     });
    ...
    //         await contract.readMyAsset(ctx, '1001').should.eventually.deep.equal({ value: 'x2rj' });
    //     });
    ...
    //         await contract.updateMyAsset(ctx, '1001', 'x2rj', 'qukuailian');
    //         ctx.stub.putState.should.have.been.calledOnceWithExactly('1001', Buffer.from('{"value":"my asset 1001 new value"}'));
    //     });

    //     it('should throw an error for a my asset that does not exist', async () => {
    //         await contract.updateMyAsset(ctx, '1003', 'x2rj', 'qukuailian').should.be.rejectedWith(/The my asset 1003 does not exist/);
    //     });
